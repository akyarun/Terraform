...
### Imperative approach — you specify the exact steps to reach a goal, in order.
...
### Declarative approach — you specify the desired end state, and let the tool figure out how to get there.
